...
public class EasyBathroomPlayReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_bathroom_play_review);
        ...
        //fill image views
        imageView.setImageBitmap((BitmapHelper.getInstance().getImage5()));
        imageView2.setImageBitmap((BitmapHelper.getInstance().getImage6()));
        imageView3.setImageBitmap((BitmapHelper.getInstance().getImage7()));
        imageView4.setImageBitmap((BitmapHelper.getInstance().getImage8()));
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EasyBathroomPlayReview.this, EasyBathroomPlayResult.class);
