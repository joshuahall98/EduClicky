...
public class EasyBedroomPlayReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_bedroom_play_review);
        ...
        //fill image views
        imageView.setImageBitmap((BitmapHelper.getInstance().getImage9()));
        imageView2.setImageBitmap((BitmapHelper.getInstance().getImage10()));
        imageView3.setImageBitmap((BitmapHelper.getInstance().getImage11()));
        imageView4.setImageBitmap((BitmapHelper.getInstance().getImage12()));
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EasyBedroomPlayReview.this, EasyBedroomPlayResult.class);
