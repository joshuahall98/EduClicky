...
public class  MediumKitchenPlayResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_kitchen_play_result);
        ...
        myRef = firebaseDatabase.getReference("ChartValuesMediumKitchen"+userID);
