...
public class MediumBathroomPlayReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_bathroom_play_review);
        ...
        //fill image views
        imageView.setImageBitmap((BitmapHelper.getInstance().getImage17()));
        imageView2.setImageBitmap((BitmapHelper.getInstance().getImage18()));
        imageView3.setImageBitmap((BitmapHelper.getInstance().getImage19()));
        imageView4.setImageBitmap((BitmapHelper.getInstance().getImage20()));
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MediumBathroomPlayReview.this, MediumBathroomPlayResult.class);
