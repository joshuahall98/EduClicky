...
public class MediumBedroomPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_bedroom_play);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(BitmapHelper.getInstance().getImage21() == null){
                    Toast.makeText(MediumBedroomPlay.this, "Please take all the pictures", Toast.LENGTH_SHORT).show();
                }
                else {
                    //sending variables between activties
                    Intent intent = new Intent(MediumBedroomPlay.this, MediumBedroomPlay2.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            BitmapHelper.getInstance().setImage21(image);
        }
