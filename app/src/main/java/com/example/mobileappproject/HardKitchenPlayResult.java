...
public class HardKitchenPlayResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_kitchen_play_result);
        ...
        myRef = firebaseDatabase.getReference("ChartValuesHardKitchen"+userID);
