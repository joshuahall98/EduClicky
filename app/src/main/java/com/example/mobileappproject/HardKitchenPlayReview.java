...
public class HardKitchenPlayReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_kitchen_play_review);
        ...
        //fill image views
        imageView.setImageBitmap((BitmapHelper.getInstance().getImage25()));
        imageView2.setImageBitmap((BitmapHelper.getInstance().getImage26()));
        imageView3.setImageBitmap((BitmapHelper.getInstance().getImage27()));
        imageView4.setImageBitmap((BitmapHelper.getInstance().getImage28()));
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(HardKitchenPlayReview.this, HardKitchenPlayResult.class);
