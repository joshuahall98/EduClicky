...
public class EasyBathroomPlay4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_bathroom_play4);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(BitmapHelper.getInstance().getImage8() == null){
                    Toast.makeText(EasyBathroomPlay4.this, "Please take all the pictures", Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent intent = new Intent(EasyBathroomPlay4.this, EasyBathroomPlayReview.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            BitmapHelper.getInstance().setImage8(image);
        }
