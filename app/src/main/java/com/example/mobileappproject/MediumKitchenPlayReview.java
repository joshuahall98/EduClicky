...
public class MediumKitchenPlayReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_kitchen_play_review);
        ...
        //fill image views
        imageView.setImageBitmap((BitmapHelper.getInstance().getImage13()));
        imageView2.setImageBitmap((BitmapHelper.getInstance().getImage14()));
        imageView3.setImageBitmap((BitmapHelper.getInstance().getImage15()));
        imageView4.setImageBitmap((BitmapHelper.getInstance().getImage16()));
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MediumKitchenPlayReview.this, MediumKitchenPlayResult.class);
