...
public class MediumBedroomPlayReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_bedroom_play_review);
        ...
        //fill image views
        imageView.setImageBitmap((BitmapHelper.getInstance().getImage21()));
        imageView2.setImageBitmap((BitmapHelper.getInstance().getImage22()));
        imageView3.setImageBitmap((BitmapHelper.getInstance().getImage23()));
        imageView4.setImageBitmap((BitmapHelper.getInstance().getImage24()));
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MediumBedroomPlayReview.this, MediumBedroomPlayResult.class);
