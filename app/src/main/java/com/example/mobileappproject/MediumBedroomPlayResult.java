...
public class MediumBedroomPlayResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_bedroom_play_result);
        ...
        myRef = firebaseDatabase.getReference("ChartValuesMediumBedroom"+userID);
