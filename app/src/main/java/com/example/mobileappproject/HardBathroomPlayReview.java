...
public class HardBathroomPlayReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_bathroom_play_review);
        ...
        //fill image views
        imageView.setImageBitmap((BitmapHelper.getInstance().getImage29()));
        imageView2.setImageBitmap((BitmapHelper.getInstance().getImage30()));
        imageView3.setImageBitmap((BitmapHelper.getInstance().getImage31()));
        imageView4.setImageBitmap((BitmapHelper.getInstance().getImage32()));
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(HardBathroomPlayReview.this, HardBathroomPlayResult.class);
