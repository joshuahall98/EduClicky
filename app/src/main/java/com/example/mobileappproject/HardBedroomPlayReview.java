...
public class HardBedroomPlayReview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_bedroom_play_review);
        ...
        //fill image views
        imageView.setImageBitmap((BitmapHelper.getInstance().getImage33()));
        imageView2.setImageBitmap((BitmapHelper.getInstance().getImage34()));
        imageView3.setImageBitmap((BitmapHelper.getInstance().getImage35()));
        imageView4.setImageBitmap((BitmapHelper.getInstance().getImage36()));
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(HardBedroomPlayReview.this, HardBedroomPlayResult.class);
