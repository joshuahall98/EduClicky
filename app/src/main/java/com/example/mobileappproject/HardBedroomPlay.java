...
public class HardBedroomPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_bedroom_play);
        ...
        kitchen.add("Wardrobe");
        kitchen.add("Radiator");
        kitchen.add("Charger");
        kitchen.add("Ceiling");
        kitchen.add("Mattress");
        kitchen.add("Blanket");
        kitchen.add("Trousers");
        kitchen.add("Sweater");
        kitchen.add("Curtains");
        kitchen.add("Picture");
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(BitmapHelper.getInstance().getImage33() == null){
                    Toast.makeText(HardBedroomPlay.this, "Please take all the pictures", Toast.LENGTH_SHORT).show();
                }
                else {
                    //sending variables between activties
                    Intent intent = new Intent(HardBedroomPlay.this, HardBedroomPlay2.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            BitmapHelper.getInstance().setImage33(image);
        }
