...
public class HardBathroomPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_bathroom_play);
        ...
        kitchen.add("Toothpaste");
        kitchen.add("Toothbrush");
        kitchen.add("Shampoo");
        kitchen.add("Shower Head");
        kitchen.add("Toilet Paper");
        kitchen.add("Conditioner");
        kitchen.add("Shower Screen");
        kitchen.add("Light Bulb");
        kitchen.add("Hand Towel");
        kitchen.add("Radiator");
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(BitmapHelper.getInstance().getImage29() == null){
                    Toast.makeText(HardBathroomPlay.this, "Please take all the pictures", Toast.LENGTH_SHORT).show();
                }
                else {
                    //sending variables between activties
                    Intent intent = new Intent(HardBathroomPlay.this, HardBathroomPlay2.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            BitmapHelper.getInstance().setImage29(image);
        }
