...
public class MediumBathroomPlay2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_bathroom_play2);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(BitmapHelper.getInstance().getImage18() == null){
                    Toast.makeText(MediumBathroomPlay2.this, "Please take all the pictures", Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent intent = new Intent(MediumBathroomPlay2.this, MediumBathroomPlay3.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            BitmapHelper.getInstance().setImage18(image);
        }
