...
public class EasyBedroomPlayResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_bedroom_play_result);
        ...
        myRef = firebaseDatabase.getReference("ChartValuesEasyBedroom"+userID);
