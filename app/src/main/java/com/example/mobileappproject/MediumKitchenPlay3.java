...
public class MediumKitchenPlay3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_kitchen_play3);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(BitmapHelper.getInstance().getImage15() == null){
                    Toast.makeText(MediumKitchenPlay3.this, "Please take all the pictures", Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent intent = new Intent(MediumKitchenPlay3.this, MediumKitchenPlay4.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            BitmapHelper.getInstance().setImage15(image);
        }
