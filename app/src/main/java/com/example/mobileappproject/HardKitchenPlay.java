...
public class HardKitchenPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_kitchen_play);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(BitmapHelper.getInstance().getImage25() == null){
                    Toast.makeText(HardKitchenPlay.this, "Please take all the pictures", Toast.LENGTH_SHORT).show();
                }
                else {
                    //sending variables between activties
                    Intent intent = new Intent(HardKitchenPlay.this, HardKitchenPlay2.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            BitmapHelper.getInstance().setImage25(image);
        }
