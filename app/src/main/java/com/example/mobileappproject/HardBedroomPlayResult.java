...
public class HardBedroomPlayResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_bedroom_play_result);
        ...
        myRef = firebaseDatabase.getReference("ChartValuesHardBedroom"+userID);
