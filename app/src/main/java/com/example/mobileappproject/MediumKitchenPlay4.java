...
public class MediumKitchenPlay4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_kitchen_play4);
        ...
        continueBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(BitmapHelper.getInstance().getImage16() == null){
                    Toast.makeText(MediumKitchenPlay4.this, "Please take all the pictures", Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent intent = new Intent(MediumKitchenPlay4.this, MediumKitchenPlayReview.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CAMERA_REQUEST_CODE) {
            ...
            BitmapHelper.getInstance().setImage16(image);
        }
